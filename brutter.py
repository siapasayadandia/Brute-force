#!/usr/bin/env python
# -*- coding:utf-8 -*-
# Coded by Anonymus (siapasayadandia)
...
class iCloudBrute(object):
    ...
    def banner(self):
        ...
        print(r"; #         _:(  -) by Anonymus (siapasayadandia)")
        print(r":          (_____/  https://github.com/siapasayadandia")
        print(r":            :      ")
        print(r" '.___..___.`       ")
        print("                     ")
    ...
    def usage(self):
        ...
        print("\t--tor\t\tUse tor\n")
        print("Example:")
        print("\t%s --idw dir/test_account.txt --wordlist dir/folder/file.txt"%(sys.argv[0]))
